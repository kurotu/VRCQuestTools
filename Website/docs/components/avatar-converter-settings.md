...
- Components which can't be used on Mobile (such as Audio Source) are removed during conversion. The components to be removed are shown as warnings in the Inspector.
