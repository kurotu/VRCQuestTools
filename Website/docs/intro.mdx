...
This is a simple way to convert your avatar for Android using VRCQuestTools.
Please refer to the [Tutorial](category/tutorial) category for more details.
...
3. Click **Begin Converter Settings** button in the opened window, then click **Convert** button.
    ...
    (Reference: [Tutorial: Non-Destructive Conversion](tutorial/non-destructive-workflow.md))
    :::
...
6. Select **Android** platform, then click **Switch Platform** button in the opened window.
    ...
    (Reference: [Tutorial: Set up Environment](tutorial/set-up-environment.mdx))
    :::
