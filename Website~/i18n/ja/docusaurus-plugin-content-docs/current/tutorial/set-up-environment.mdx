...
:::info Good: Android Build Supportがインストールされている
![Android Module](/img/unity_android_ok.png)
You can go to the next step, [Install VRCQuestTools](#install-vrcquesttools).
:::

:::caution No Good: Android Build Supportがない
![No Android Module](/img/unity_android_ng.png)
:::
...
5. VRCQuestToolsが`Assets/KRT/VRCQuestTools`フォルダに追加されます。

## Unity Package Manager (UPM)

UPMでプロジェクトに`https://github.com/kurotu/VRCQuestTools.git`をインポートします。
