...
- Fixed an issue where lilToon Main Color 2nd/3rd, when used as decal and animated, were not correctly baked into the main texture. (Requires lilToon x.x.x or later)
