...
#pragma warning disable SA1600
        ...
        internal const string UnknownTextureFormatTitle = "NonFatal:Unknown Texture Format";
        internal const string UnknownTextureFormatDescription = "Unknown texture format {0} is used for {1}.";
        ...
        internal static Localizer Instance = new Localizer("en-US", () => new List<(string, System.Func<string, string>)>
        {
            ("en-US", (key) =>
            {
                switch (key)
                {
                    ...
                    case UnknownTextureFormatDescription:
                        return "Unknown texture format {0} is used for {1}. Please report to the tool's developer to suppress this warning.";
                }
                return key;
            }),
            ("ja-JP", (key) =>
            {
                switch (key)
                {
                    ...
                    case UnknownTextureFormatTitle:
                        return "未知のテクスチャフォーマット";
                    case UnknownTextureFormatDescription:
                        return "未知のテクスチャフォーマット {0} が {1} で使用されています。この警告を抑制するためには、ツールの開発者に報告してください。";
                }
                return key;
            }),
        });
